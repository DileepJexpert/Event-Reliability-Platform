...
public class ApprovalController {
    ...
    /** {@code GET /api/approvals} — pending requests awaiting a checker, oldest first. */
    @GetMapping
    public List<ApprovalDto> pending() {
        return readModels.pendingApprovals().stream()
    ...
    private ApprovalDto toDto(ControlRequest r) {
        ...
        return new ApprovalDto(r.requestId(), r.type().name(), r.correlationId(), r.incidentId(),
                ...
                r.checker(), r.checkerReason(), r.decidedAt());
    }
}
